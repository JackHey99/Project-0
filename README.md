...
## Introduction
The aim of this project is to design an embedded system that can measure a person's subjective flicker fusion. The system must not contain any delay() functions, the button must be de-bounced and the flicker frequency must triggered by an interrupt and serially printed to the monitor. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTcxMzE3OTY5LC0xODIyOTg3NzEzXX0=
-->